# Full rebuild — drop the OVERWATCH objects and reinstall V001..V080
...
then run all 80 migrations in order. Same end state as a virgin install.
...
V001 → V080, each file fully, **stopping at the first error** — never run
...
- If you kept operator data, SCHEMA_VERSION already holds 1..80: the
...
(DEPLOYMENT.md). App v4.158.0 expects exactly V001..V080.
