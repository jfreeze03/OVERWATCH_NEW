...
def test_canary_release_anchor_is_recent_not_fixed():
    ...
    # The anchor is ACCOUNT-time (America/Chicago) by contract — comparing
    # against the runner's local date.today() made this fail every day between
    # midnight UTC and midnight Chicago (v4.155 fix: assert the real contract).
