...
def test_multiselect_chips_are_readable():
    ...
    # v4.155 recolor: the chip tint follows the indigo accent (was sky).
    assert "rgba(129,140,248,0.16)" in theme           # dark chip, not the pale wash
    assert 'tag"] span { color:#e0e7ff' in theme       # readable text
