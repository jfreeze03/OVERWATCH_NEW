...
CANARIES: tuple[tuple[str, Callable[[], str]], ...] = (
    ...
    ("security.identity_policies", security_sql.identity_policies),
    ("security.egress_policies", security_sql.egress_policies),
    ("security.client_policies", security_sql.client_policies),
    ...
    ("security.access_review_campaigns", lambda: security_sql.access_review_campaigns(1)),
    ("security.access_review_items", lambda: security_sql.access_review_items("CANARY", 1)),
    ("security.access_review_decisions", lambda: security_sql.access_review_decisions("CANARY", 1)),
