...
def _capacity_forecast_panel(company: str) -> None:
    ...
    section_header("Capacity pressure forecast", anchor="opt-capacity")
    st.caption(
...
def _optimization_tab(company: str, days: int, rate: float, settings: dict, is_operator: bool) -> None:
    ...
    if opt_section == "Idle & sizing":
        ...
        section_header("Idle warehouse advisor", icon_name="warehouse",
                       anchor="opt-idle")
        ...
        section_header("Warehouse right-sizing simulator", icon_name="warehouse",
                       anchor="opt-rightsize")
        st.caption(
        ...
        section_header("Most expensive queries", badge="allocated $",
                       icon_name="search", anchor="opt-queries")
        ...
        section_header("Recurring cost patterns", badge="same query, run all day",
                       anchor="opt-patterns")
        ...
        section_header("Repeat-query candidates", badge="cache / materialization",
                       anchor="opt-repeat")
        ...
        # ---- Object cost ledger ----------------------------------------------------
        section_header("Object cost ledger", badge="measured + maintenance",
                       anchor="opt-ledger")
        st.caption(
        ...
        section_header("Storage growth movers", anchor="opt-growth")
        ...
        section_header("Query efficiency", badge="pruning + result cache",
                       anchor="opt-efficiency")
        ...
        section_header("Storage waste", badge="Time Travel / failsafe / stale tables",
                       anchor="opt-waste")
        ...
        section_header("Automatic clustering spend", badge="per table",
                       anchor="opt-clustering")
        ...
        section_header("Guarded remediation", badge="generate → review → execute",
                       icon_name="bolt", anchor="opt-remediation")
        panel_help(
        ...
        if remlog.ok and not remlog.empty:
            section_header("Remediation history", anchor="opt-rem-history")
...
def _savings_tab() -> None:
    ...
    if runs.usable():
        section_header("Auto-verification", badge="monthly re-measurement",
                       anchor="opt-autoverify")
        st.caption(
