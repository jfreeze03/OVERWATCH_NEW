...
-- ===========================================================================
--  APPLY THE OWNER-GATED MIGRATION BACKLOG: V118 -> V122, IN ORDER.
--
...
--
--  AFTER RUN ALL:
--    * The last block prints SCHEMA_VERSION -- confirm it reads 122.
--    * V120 (loader) and V122 (sweep) re-run themselves in-file above. The
--      post-apply block below also re-runs SP_ALERT_SCAN() once so V119's
--      corrected auto-clear re-stamps open alerts immediately (it would
...
-- LOOK FOR: five rows, VERSION 118..122, APPLIED_AT just now.
-- RESULT:
