# One-shot full rebuild (regenerated by outputs/gen_rebuild_bundle.py)
...
| 02 | 02_migrations_V001_V125.sql | all 125 migrations, in order | runs to the end; halts AT the failure if any |
